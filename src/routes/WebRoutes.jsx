...
const WebRoutes = {
  path: "/",
  children: [
    { index: true, element: <Navigate to="cliberduche-website" replace /> },
    { path: "cliberduche-website", element: <CliberducheWebsite /> },
    { path: "cliberduche-website/cbd-2019", element: <CBD_2019Main /> },
    { path: "cliberduche-website/mdi-2024", element: <MDI_2024Main /> },
    { path: "cliberduche-website/mdi-2025", element: <MDI_2025Main /> },
    { path: "cliberduche-website/mdi-2026", element: <MDI_2026Main /> },
    {
    ...
    { path: "cliberduche-website/admin", element: <Admin /> },
  ],
};

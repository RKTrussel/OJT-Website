...
const Mission = ({ refProp, visible }) => {
  return (
    <section
      id="mission"
      ref={refProp}
      className={`bg-gradient-to-br from-gray-50 to-gray-100 py-16 transition-all duration-700 ${
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              committed to international standards, environmental conservation,
              and sustainable projects that contribute to future commercial and

      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="relative h-110 flex items-center justify-center">
            ...
            <button
              onClick={prev}
              className="absolute left-0 sm:left-2 md:left-4 z-30 bg-white/70 hover:bg-white shadow rounded-full p-3 sm:p-4 transition"
            >
            ...
            <button
              onClick={next}
              className="absolute right-0 sm:right-2 md:right-4 z-30 bg-white/70 hover:bg-white shadow rounded-full p-3 sm:p-4 transition"
            >
...
const DeckCard = ({ project, position, onClick, active }) => {
  const base =
    "absolute rounded-2xl overflow-hidden shadow-xl transition-all duration-500 cursor-pointer transform";

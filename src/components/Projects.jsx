      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-center mb-10">
            ...
            and industrial projects. Our expertise includes land clearing,
            cutting and leveling, drainage installation, road and bridge
            construction, slope protection, erosion prevention, and soil
            stabilization works.
          </p>

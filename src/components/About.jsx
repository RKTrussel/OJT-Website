    ...
    >
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p>
            We provide premium backfill materials such as sub-base, aggregates,
            and boulders. Our land development sites in Laguna and Cavite
            contain over 14 million cubic meters of backfilling materials to
            support the growing construction industry.
          </p>
        </div>
        <div>
          <img

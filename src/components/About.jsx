      ...
      >
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            <div className="absolute inset-0 bg-linear-to-r from-green-100/30 via-blue-100/30 to-green-100/30 rounded-3xl -z-10"></div>
          ...
          <div className="space-y-16">
            {/* Our Beginning */}
            <div
              className="relative overflow-hidden rounded-3xl shadow-2xl animate-fade-in-up"
            ...
            >
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-r from-green-900/80 to-blue-900/80"></div>
              </div>
            ...
            >
              <div className="absolute inset-0">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-linear-to-l from-blue-900/80 to-green-900/80"></div>
              </div>
              <div className="relative z-10 p-16 text-white">
                <div className="max-w-2xl ml-auto">
                  ...
                  <div
                    className="bg-white/10 backdrop-blur-sm rounded-xl p-6 ml-auto"
            ...
            >
              <div className="absolute inset-0">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-linear-to-r from-blue-900/80 via-green-900/60 to-blue-900/80"></div>
              </div>
              <div className="relative z-10 p-16 text-white">

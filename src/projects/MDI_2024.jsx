...
import Picture7 from "../img/MDI2024_Images/Picture7.png";
import Picture8 from "../img/MDI2024_Images/Picture8.png";
import Picture9 from "../img/MDI2024_Images/Picture9.png";
import Picture10 from "../img/MDI2024_Images/Picture10.png";

// Add all projects images here
const GALLERY_IMAGES = [Picture7, Picture8, Picture9, Picture10];

const MDI_2024 = () => {
  const heroImages = [Picture7, Picture8, Picture9, Picture10];
        ...
        <div className="relative z-10 mt-10 max-w-300 mx-auto h-full flex items-center px-6">
          <div className="max-w-xl text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              MDI - MERCATOR HOLDINGS PROJECT 2024
            </h1>
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                CLEARING, GRUBBING, TEMPORARY FENCE REMOVAL OF UNSUITABLE SOIL
                AND LEVELING
              </p>
            </div>
